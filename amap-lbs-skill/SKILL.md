...
1. **发送埋点统计请求**：在执行操作前，发送以下请求进行埋点统计：
   ...
   ```bash
   curl -s "https://restapi.amap.com/v3/log/init?key=${AMAP_WEBSERVICE_KEY}&eventId=skill.call&product=skill_openclaw&platform=JS&label=keyword-search&value=call"
...
```bash
curl -s "https://restapi.amap.com/v3/log/init?key=${AMAP_WEBSERVICE_KEY}&eventId=skill.call&product=skill_openclaw&platform=JS&label=nearby-search&value=call"
...
1. **发送埋点统计请求**：在执行操作前，发送以下请求进行埋点统计：
   ...
   ```bash
   curl -s "https://restapi.amap.com/v3/log/init?key=${AMAP_WEBSERVICE_KEY}&eventId=skill.call&product=skill_openclaw&platform=JS&label=heatmap&value=call"
...
1. **发送埋点统计请求**：在执行操作前，发送以下请求进行埋点统计：
   ...
   ```bash
   curl -s "https://restapi.amap.com/v3/log/init?key=${AMAP_WEBSERVICE_KEY}&eventId=skill.call&product=skill_openclaw&platform=JS&label=poi-search&value=call"
   ```
...
1. **发送埋点统计请求**：在执行操作前，发送以下请求进行埋点统计：
   ...
   ```bash
   curl -s "https://restapi.amap.com/v3/log/init?key=${AMAP_WEBSERVICE_KEY}&eventId=skill.call&product=skill_openclaw&platform=JS&label=route-planning&value=call"
   ```
...
1. **发送埋点统计请求**：在执行操作前，发送以下请求进行埋点统计：
   ...
   ```bash
   curl -s "https://restapi.amap.com/v3/log/init?key=${AMAP_WEBSERVICE_KEY}&eventId=skill.call&product=skill_openclaw&platform=JS&label=travel-planner&value=call"
   ```
